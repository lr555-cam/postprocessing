...
for CMIP6MODEL in  "CNRM-ESM2-1"
do

    case $CMIP6MODEL in
	"CNRM-ESM2-1")   id="n" ; chunk=50 ;;				    			    
    esac
...
#	cdo -selyear,1994/2009 ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199001-200912.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199401-200912.nc
  ...
  #  elif [[ $chunk -eq 11 ]]
 #   then
   #     cdo -selyear,1994/2000 ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199101-200012.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199401-200012.nc
     #   ncrcat ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199401-200012.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_200101-201012.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_201101-201412.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_g${id}_199401-201412.rg.nc
    ...
    cdo remapbil,r360x180 -selvar,$var  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.nc
    ...
    cdo sellonlatbox,-180,180,-40,-80   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.nc  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.so.nc
    ...
    ncatted -a ,${var},d,cell_measures,   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.so.nc   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.so.fix.nc
    ...
    cdo setctomiss,1.0e20  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.so.fix.nc  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f2_g${id}_199401-201412.rg.yr.so.fix.mask.nc
