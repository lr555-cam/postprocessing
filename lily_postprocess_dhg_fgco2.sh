...
#for CMIP6MODEL in "ACCESS-ESM1-5" "BCC-CSM2-MR" "BCC-ESM1" "CESM2" "CESM2-WACCM" "CMCC-ESM2" "CNRM-ESM2" "NorCPM1"
#do

for CMIP6MODEL in "GFDL-CM4" "GFDL-ESM4" "CESM2-FV2" "MPI-ESM1-2-HR" "MPI-ESM1-2-LR" "MPI-ESM-1-2-HAM" "NorESM2-MM" 
do
    ...
    cdo remapbil,r360x180 -selvar,$var  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_185001-201412.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_185001-201412.rg.nc
    ...
    cdo -selyear,1994/2014 ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_185001-201412.rg.nc ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.nc
    ...
    cdo sellonlatbox,-180,180,-40,-80   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.nc  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.so.nc
    ...
    ncatted -a ,${var},d,cell_measures,   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.so.nc   ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.so.fix.nc
    ...
    cdo setctomiss,1.0e20  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.so.fix.nc  ${var}_Omon_${CMIP6MODEL}_historical_r1i1p1f1_gn_199401-201412.rg.yr.so.fix.mask.nc
